...
const Menu = () => {
  return (
    <div className="w-full h-screen bg-gray-200 flex justify-center items-center gap-3">
      <div className="w-[450px] h-[250px] bg-yellow-200 overflow-hidden order-4 border-zinc-700 shadow-md shadow-zinc-600 relative flex items-center">
        ...
        <div className="absolute left-[55%] flex flex-col justify-center w-[45%] h-2/3 my-auto border-l-2 border-zinc-500 text-center">
