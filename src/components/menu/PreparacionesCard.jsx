  ...
  return (
    <li className="flex flex-col items-center">
      <div
        ...
        className={`w-36 h-36 xl:w-48 xl:h-48 rounded-full border-2 border-orange-400 flex justify-center items-center shadow-md shadow-gray-500 hover:ring  hover:cursor-pointer bg-white hover:scale-105 ease-in duration-200 ring-red-700 ${
